...
GLfloat cx = 0, cy = 0, cz = 4, ex = 0,  ey = 0,ez = 0;
bool light1 = false;
bool light2 = false;
bool light3 = false;
...
void display(void) {
    ...
    glPushMatrix();
    glScalef(.8, .1, 4);
    glTranslatef(0, -13, 0.2);
    cube3(V[0], V[1], V[2], V[3], V[4], V[5], V[6], V[7], 1.0, 0.0, 0.0);
    glPopMatrix();
    //blanket
    glPushMatrix();
    glScalef(.75, .02, .8);
    glTranslatef(0, -62, 3);
    cube3(V[0], V[1], V[2], V[3], V[4], V[5], V[6], V[7], 0.255, 0.412, 0.882);
    glPopMatrix();
    //pillow-left
    glPushMatrix();
    glScalef(.3, .05, .8);
    glTranslatef(-1.2, -24, .06);
    cube3(V[0], V[1], V[2], V[3], V[4], V[5], V[6], V[7], 1.000, 0.843, 0.000);
    glPopMatrix();
    //pillow-right
    glPushMatrix();
    glScalef(.3, .05, .8);
    glTranslatef(1.4, -24, .06);
    cube3(V[0], V[1], V[2], V[3], V[4], V[5], V[6], V[7], 1.000, 0.843, 0.000);
    glPopMatrix();
    glPopMatrix();
    //Mat
    ...
    for (int i = 0; i < 360; i += 1) {
        ...
        glRotatef(30, 0, 0, 1);
        glScalef(.1f, 1, .1f);
        cube3(c[0], c[1], c[2], c[3], c[4], c[5], c[6], c[7], 0.416, 0.353, 0.80);
        glPopMatrix();
    }
    glPopMatrix();
    //lamp handle
    glPushMatrix();
    glTranslatef(1.5, -.6, -2.8);
    glScalef(.02, .4, .1);
    cube2(V[0], V[1], V[2], V[3], V[4], V[5], V[6], V[7]);
    glPopMatrix();
    //lamp base
